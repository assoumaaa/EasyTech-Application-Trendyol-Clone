...
import 'package:week6_starter/routes/favorites.dart';
              ...
              child: ListView(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(
                      'Register',
                      style: TextStyle(fontSize: 36.0, color: AppColors.textColor),
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          await _firebaseAuth
                              ...
                              Navigator.push( context, MaterialPageRoute(builder: (context) => RouteControl()),);
                            });
                          }).catchError((onError) {
